...
% https://github.com/swz30/MPRNet/blob/main/Deraining/evaluate_PSNR_SSIM.m

% edited code: imresize(gt)->size(input)
...
for idx_set = 1:num_set
    file_path = 'C:\Users\ZHENGDIAN\Desktop\SOTS\';
    gt_path = "C:\Users\ZHENGDIAN\Desktop\unirestore_result\SOTS_gt\";
    ...
    if img_num > 0 
        for j = 1:img_num 
           ...
           gt_name = strcat(gt_name_fen(1), '.png');
