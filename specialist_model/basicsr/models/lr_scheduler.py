...
class CosineAnnealingRestartCyclicLR(_LRScheduler):
    ...
    def get_lr(self):
        idx = get_position_from_periods(self.last_epoch,
                                        self.cumulative_period)
        # print('idx',idx)
        # print('self.cumulative_period', self.cumulative_period)
        # print('self.restart_weights', self.restart_weights)
...
class CosineAnnealingRestartLR(_LRScheduler):
    ...
    def __init__(self, optimizer, periods, restart_weights=[1, 1], eta_min=0, last_epoch=-1):
        self.periods = periods
        self.restart_weights = [1, 1]
